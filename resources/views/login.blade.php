        ...
        <div class="w-full max-w-md mb-6 animate-fadeIn" id="error-notice-banner">
            <div class="flex items-start gap-3 bg-[#fdf2f2] border border-[#f8b4b4] rounded-xl p-4 shadow-xs">
                ...
                <div class="space-y-1">
                    ...
                    <a href="{{ route('signup') }}?email={{ urlencode(session('unregistered_email', old('email', ''))) }}" class="inline-flex items-center gap-1.5 text-xs font-bold text-[#b93838] hover:text-[#7f1d1d] underline pt-1">
